...
<body>
	<div>
		<img width="100px" style="float:left;margin-right:8px;" src="https://picsum.photos/400/400">
					...
					<table class="table table-striped">
						<tbody>
							...
							<tr>
								...
								<td><select class="form-control" id="country">
									</select></td>
							</tr>
							<tr>
								<th><label for="states">State:</label></th>
								<td><select class="form-control" id="states">
										<option>Select region...</option>
									</select></td>
							</tr>
							<tr>
								<th><label for="cities">City:</label></th>
								<td><select class="form-control" id="cities">
							...
							<tr>
								...
								<td><input type="text" placeholder="External ID" id="externalStoreID"></td>
							</tr>
						</tbody>
					</table>
		...
		<div class="card">
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
				<div class="card-body">
					...
					<label for="externalStoreIDPOS">External Store ID:</label><input type="text" placeholder="External Store ID"
						id="externalStoreIDPOS"><br />
					<label for="externalPOSID">External POS ID:</label><input type="text" placeholder="External ID"
						id="externalPOSID"><br />
					<br />
		...
		<div class="card">
			...
			<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
				<div class="card-body">
					...
					<label for="external_id">External_POS_ID:</label><input type="text" id="external_id"
						placeholder="External_ID">
					<label for="external_reference">External_Reference:</label><input type="text" id="external_reference"
